...
## Witboost Adapter Attach

Use `/witboost-adapter-attach` to activate this workflow.
...
## Witboost Adapter Bootstrap

Use `/witboost-adapter-bootstrap` to activate this workflow.

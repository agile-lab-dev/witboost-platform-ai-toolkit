...
npx skills add \
  "https://gitlab.com/AgileFactory/Witboost.Mesh/ai/witboost-tech-adapter-ai-toolkit.git#v0.2.4" \
...
```bash
npx @witboost/ai-toolkit@0.2.4 setup --dir .
npx @witboost/ai-toolkit@0.2.4 doctor --dir .
```
...
```bash
npx @witboost/ai-toolkit@0.2.4 create tech-adapter java my-adapter --dir .
```

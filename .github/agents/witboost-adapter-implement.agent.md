---
name: Witboost Adapter Implement
description: "Implement a locked Witboost tech adapter design change: smallest viable patch set, focused validation, and follow-up gaps. Use once a feature design or review outcome is locked and ready to be coded in the target repository."
tools: [read, search, edit, execute, todo]
argument-hint: "Point to the locked decision or reviewed finding to implement, and the target repository."
agents: []
handoffs: [witboost-adapter-test]
---

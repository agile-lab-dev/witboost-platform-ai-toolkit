---
name: Witboost Adapter Attach
description: "Attach the Witboost tech adapter workflow to an existing (or freshly bootstrapped) tech adapter repository: reconstruct its lifecycle and ownership boundaries from real routes, scripts, tests, and docs. Use when a target tech adapter repository already exists and its actual contract needs to be reconstructed before any design, review, or implementation."
tools: [read, search, edit, todo]
argument-hint: "Give the target tech adapter repository path or name and the platform it wraps."
agents: []

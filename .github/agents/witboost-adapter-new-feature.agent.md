---
name: Witboost Adapter New Feature
description: "Define or customize a Witboost tech adapter feature end to end: elicit the desired business behavior, resolve template versus descriptor boundaries, deploy/undeploy/validate/updateAcl lifecycle modeling, naming conventions, and sync versus async choices. Use to design a new capability or customize an existing one without losing lifecycle correctness."
tools: [read, search, edit, todo]
argument-hint: "Describe the desired business behavior of the new or changed feature — not just a lifecycle name like 'updateAcl'."
agents: []
handoffs: [witboost-adapter-review, witboost-adapter-implement]
---
